...
<html lang='en'>
 ...
 <body>
    ...
    <!-- Creative Commons image sourced from https://pixabay.com/en/maintenance-under-construction-2422173/ and used for educational purposes only -->
          <div class="desc">
              A-COLD-WALL BRACKET LOGO LONGSLEEVE<br><br>
              $360.00 AUD<br><br>
              A COLD WALL BRACKET LOGO T-SHIRT.  THIS BLACK LONG SLEEVE FEATURES YELLOW BRACKET LOGOS AT THE CHEST.  BOTH SLEEVE CUFFS AND BACK HEM.  THE BACK LOGO FEATURES A DUCT TAPE STRIPE WITH BLACK SPRAY PAINT DOWN THE CENTER.  <br><br>
              MADE IN ITALY<br><br>
          </div>
          <div class="img"><img src="../../media/6262.PNG" width="100%" height="100%"></div>
      </article>
    </main> 
