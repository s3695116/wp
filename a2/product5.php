...
<html lang='en'>
 ...
 <body>
    ...
    <!-- Creative Commons image sourced from https://pixabay.com/en/maintenance-under-construction-2422173/ and used for educational purposes only -->
          <div class="desc">
              BALENCIAGA WMNS TUBE JEANS<br><br>
              $860.00 AUD<br><br>
              BALENCIAGA WMNS TUDE JEANS.  5 POCKETS DENIM PANTS.  HIGH WAIST AND STRAIGHT LEG.  NATURAL FIBRE.  HIGH WAIST AND STRAIGHT LEG.  FITTED MUM JEANS STYLE.  VISIBLE BUTTONING.  BRASS RIVETS AND ENGRAVED BALENCIAGA FLEX BUTTONS.<br><br>
          </div>
          <div class="img"><img src="../../media/8989.PNG" width="80%" height="120%"></div>
      </article>
    </main> 
